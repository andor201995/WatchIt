...
class FragmentInjector @Inject constructor(
    private val fragmentInjectorFactoryMap: Map<Class<out Fragment>, @JvmSuppressWildcards Provider<AndroidInjector.Factory<out Fragment>>>
) {
    ...
    fun inject(fragment: Fragment) {
        ...
        val injectorFactory =
            fragmentInjectorFactoryMap[fragment::class.java]?.get() as AndroidInjector.Factory<Fragment>
